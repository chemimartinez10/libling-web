...
const AnimatedImage:React.FC<IAnimatedImage> = ({image, alt, reverse = false}) => {
  return (
    <div className={styles.container}>
        ...
        <div className={reverse ? styles.squareReversed : styles.square} style={{backgroundColor:'#FFB34C', top:8, left:reverse ? undefined : 8, right:reverse ? 8 : undefined, zIndex:1}}></div>
