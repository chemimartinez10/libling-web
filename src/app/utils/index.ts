export const dict = {
	es: {
		...
		about: {
			...
			sectionContent_1_2: " es la primera empresa hispanoamericana de reubicación e inmobiliaria en el Gran Ducado de Luxemburgo. Fue creada y está dirigida por ",
			sectionContent_1_3: "Madame Lidiz Cruz",
			sectionContent_1_4: ", luxemburguesa y hondureña, quien cree firmemente que con la información y la guía de excelencia podrás tener éxito en tu mudanza e integración en Luxemburgo.",
			actionButton_1_1:"Saber más",
			sectionTitle_2: "Profesionalidad",
			sectionSubtitle_2: "Innovadores en relocalización y agencia inmobiliaria en el gran ducado",
			sectionContent_2_1: "En ",
			sectionContent_2_2: "Libling Solutions",
			sectionContent_2_3: " encontrarás todo lo que necesitas. Sabemos que la reubicación debe ser grata y personalizada, garantizándote a ti y a tu familia un proceso de reubicación de excelencia.",
	...
	en: {
		...
		about: {
			...
			headerSubtitle_1: "Do you yearn for a new beginning in the heart of Europe?",
			headerContent_1_1: "Libling Solutions",
			...
			sectionContent_1_1: "Libling Solutions",
			sectionContent_1_2: " is the first Spanish-American relocation and real estate company in the Grand Duchy of Luxembourg. It was created and is led by ",
			sectionContent_1_3: "Madame Lidiz Cruz",
			sectionContent_1_4: ", a Luxembourg national and Honduran national, who firmly believes that with the right information and guidance, you can be successful in your move and integration into Luxembourg.",
			actionButton_1_1: "Learn more",
			sectionTitle_2: "Professionalism",
			sectionSubtitle_2: "Innovators in relocation and real estate agency in the Grand Duchy",
			sectionContent_2_1: "At ",
			sectionContent_2_2: "Libling Solutions",
			sectionContent_2_3: " you will find everything you need. We know that relocation should be pleasant and personalized, guaranteeing you and your family an excellent relocation process.",
	...
	fr: {
		...
		about: {
			...
			sectionContent_1_1: "Libling Solutions",
			sectionContent_1_2: " est la première société hispano-américaine de relocalisation et d'immobilier au Grand-Duché de Luxembourg. Elle a été créée et est dirigée par ",
			sectionContent_1_3: "Madame Lidiz Cruz",
			sectionContent_1_4: ", luxembourgeoise et hondurienne, qui croit fermement qu'avec les bonnes informations et les bons conseils, vous pouvez réussir votre déménagement et votre intégration au Luxembourg.",
			actionButton_1_1: "En savoir plus",
			sectionTitle_2: "Professionnalisme",
			sectionSubtitle_2: "Innovateurs en relocalisation et agence immobilière au Grand-Duché",
			sectionContent_2_1: "Chez ",
			sectionContent_2_2: "Libling Solutions",
			sectionContent_2_3: " vous trouverez tout ce dont vous avez besoin. Nous savons que la relocalisation doit être agréable et personnalisée, afin de vous garantir, à vous et à votre famille, un processus de relocalisation d'excellence.",
