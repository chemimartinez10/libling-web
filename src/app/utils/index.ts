export const dict = {
	es: {
		...
		about: {
			...
			headerContent_1_2: ", la primera empresa hispanoamericana de reubicación e inmobiliaria en Luxemburgo, te acompaña en cada paso hacia un futuro brillante.",
			actionButton_1:"Entérate de lo que Libling te ofrece",
			sectionTitle_2: "Una nueva vida",
			sectionSubtitle_2: "¿Mudarte a Luxemburgo?",
			sectionContent_2_1: "Libling Solutions",
			sectionContent_2_2: " te abre las puertas a un proceso de reubicación personalizado y sin estrés. Nos enfocamos en crear una experiencia placentera y cómoda para ti y tu familia.",
			actionButton_2:"Quiero agendar una cita",
			sectionTitle_3: "profesionalidad",
			sectionSubtitle_3: "Priorizamos tu bienestar",
			sectionContent_3_1: "Nuestro equipo de profesionales multilingües y ",
			sectionContent_3_2: "altamente capacitados",
			sectionContent_3_3: " te ofrece un servicio personalizado y de calidad, desde la búsqueda del hogar ideal hasta la gestión de trámites administrativos.",
			actionButton_3:"Quiero agendar una cita",
			sectionTitle_4: "Contacto",
	...
	en: {
		...
		about: {
			...
			headerContent_1_1: "Libling Solutions",
			headerContent_1_2: ", the first Spanish-American relocation and real estate company in Luxembourg, accompanies you every step of the way towards a bright future.",
			actionButton_1: "Learn what Libling has to offer you",
			sectionTitle_2: "A new life",
			sectionSubtitle_2: "Moving to Luxembourg?",
			sectionContent_2_1: "Libling Solutions",
			sectionContent_2_2: " opens the doors to a personalized and stress-free relocation process. We focus on creating a pleasant and comfortable experience for you and your family.",
			actionButton_2: "I want to schedule an appointment",
			sectionTitle_3: "Professionalism",
			sectionSubtitle_3: "We prioritize your well-being",
			sectionContent_3_1: "Our team of multilingual and ",
			sectionContent_3_2: "highly trained professionals",
			sectionContent_3_3: " offers you a personalized and quality service, from finding the ideal home to managing administrative procedures.",
			actionButton_3: "I want to schedule an appointment",
			sectionTitle_4: "Contact",
			sectionSubtitle_4_1: "Start your journey to Luxembourg with ",
			sectionSubtitle_4_2: "Libling Solutions",
			sectionContent_4: "Contact our team today and discover how we can help you create a new home.",
	...
	fr: {
		...
		about: {
			headerTitle_1: "Embarquez pour l'aventure !",
			headerSubtitle_1: "Aspirez-vous à un nouveau départ au cœur de l'Europe ?",
			headerContent_1_1: "Libling Solutions",
			headerContent_1_2: ", la première société hispano-américaine de relocalisation et d'immobilier au Luxembourg, vous accompagne à chaque étape vers un avenir brillant.",
			actionButton_1: "Découvrez ce que Libling vous offre",
			sectionTitle_2: "Une nouvelle vie",
			sectionSubtitle_2: "Déménager au Luxembourg ?",
			sectionContent_2_1: "Libling Solutions",
			sectionContent_2_2: " vous ouvre les portes d'un processus de relocalisation personnalisé et sans stress. Nous nous concentrons sur la création d'une expérience agréable et confortable pour vous et votre famille.",
			actionButton_2: "Je souhaite prendre rendez-vous",
			sectionTitle_3: "Professionnalisme",
			sectionSubtitle_3: "Nous priorisons votre bien-être",
			sectionContent_3_1: "Notre équipe de professionnels multilingues et ",
			sectionContent_3_2: "hautement qualifiés",
			sectionContent_3_3: " vous offre un service personnalisé et de qualité, de la recherche du logement idéal à la gestion des démarches administratives.",
			actionButton_3: "Je souhaite prendre rendez-vous",
			sectionTitle_4: "Contact",
			sectionSubtitle_4_1: "Commencez votre voyage au Luxembourg avec ",
			sectionSubtitle_4_2: "Libling Solutions",
			sectionContent_4: "Contactez notre équipe dès aujourd'hui et découvrez comment nous pouvons vous aider à créer un nouveau foyer.",
			actionButton_4: "Je souhaite prendre rendez-vous",
		  },
		mail: {
