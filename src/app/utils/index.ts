export const dict = {
	...
	fr: {
		...
		data: {
			...
			"Solar thermal energy": "Énergie solaire thermique",
			"Air heat pump": "Pompe à chaleur aérothermique",
			Geothermal: "Géothermie",
			Radiators: "Radiateurs",
			"Underfloor heating": "Plancher chauffant",
			Convectors: "Convecteurs",
			"Thermal emitters": "Émetteurs thermiques",
			Fireplaces: "Cheminées",
			"Heat pumps": "Pompes à chaleur",
			"Air heat pump systems": "Systèmes de pompe à chaleur aérothermique",
			"Geothermal systems": "Systèmes géothermiques",
			"Solar thermal panels": "Panneaux solaires thermiques",
			"Pellet stoves": "Poêles à granulés",
