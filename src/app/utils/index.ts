export const dict = {
	...
	en: {
		...
		home: {
			titleHeader_1: "Libling Solutions is here for you",
			titleHeader_2: "and with you, throughout the process",
			titleHeader_3: "of your relocation to Luxembourg.",
			subtitleHeader_1: "We advise and manage for you,",
			subtitleHeader_2: "ensuring a high-quality process for you.",
	...
	fr: {
		...
		home: {
			titleHeader_1: "Libling Solutions est là pour toi",
			titleHeader_2: "et à tes côtés durant ton processus",
			titleHeader_3: "de relocalisation au Luxembourg.",
			subtitleHeader_1: "Nous te conseillons et gérons pour toi,",
			subtitleHeader_2: "tout en garantissant une procédure de qualité.",
