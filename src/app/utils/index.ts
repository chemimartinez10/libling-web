export const dict = {
	es: {
		...
		services: {
			...
			cardList_4: [
				...
				"Consultoría de arquitectos",
				"Consultoría jurídica",
				"Consultoría de doctores",
	...
	en: {
		...
		services: {
			...
			cardList_4: [
				"Organization and personalized planning of your trip",
	...
	fr: {
		...
		services: {
			...
			cardList_4: [
				"Organisation et planification personnalisée de votre voyage",
