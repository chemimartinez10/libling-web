export const dict = {
	es: {
		...
		services: {
			...
			planList1: ["Actualizaciones", "Eventos y oportunidades futuras para estudiantes internacionales", "Consejos sobre cómo postularse y dónde instalarse"],
			...
			planList2: ["Actualizaciones", "Eventos y oportunidades futuras para instalarse y trabajar en Luxemburgo", "Consejos sobre cómo postularse y dónde instalarse", "⁠Búsqueda de alojamiento y acompañamiento en el proceso de mudanza", "Requisitos y documentos necesarios para la solicitud de visado de trabajo"],
			planList2Extra: ["Actualizaciones", "Eventos y oportunidades futuras para instalarse y trabajar en Luxemburgo", "Consejos sobre cómo postularse y dónde instalarse", "⁠Búsqueda de alojamiento y acompañamiento en el proceso de mudanza", "Requisitos y documentos necesarios para la solicitud de visado de trabajo", "2 días de asistencia personalizada"],
			planTitle3: "Emprendedor",
			planContent3: "Crear una empresa en Luxemburgo",
			planList3: ["Actualizaciones", "Eventos y oportunidades futuras para instalarse en el Gran Ducado", "Consejos, guía sobre la fiscalidad y las ventajas de instalarse en Luxemburgo", "Búsqueda de alojamiento y acompañamiento en el proceso de mudanza"],
			planList3Extra: ["Actualizaciones", "Eventos y oportunidades futuras para instalarse en Luxemburgo", "Consejos sobre las oportunidades fiscales en Luxemburgo", "⁠Búsqueda de alojamiento y acompañamiento en el proceso de mudanza", "Requisitos y documentos necesarios para la solicitud de visado de empresario/inversor", "2 días de asistencia personalizada"],
	...
	en: {
		...
		services: {
			...
			planList1: ["Updates", "Upcoming events and opportunities for international students", "Advice on how to apply and where to settle in"],
			planList1Extra: ["Updates", "Upcoming events and opportunities for international students", "Advice on how to apply and where to settle in", "Ongoing support throughout your adaptation process", "Full processing of documents and authorizations", "⁠Housing search and support with the relocation process", "2 days of personalized assistance"],
			planTitle2: "Job Seeker",
			planContent2: "Settle in Luxembourg",
			planList2: ["Updates", "Upcoming events and opportunities to settle and work in Luxembourg", "Advice on how to apply and where to settle in", "⁠Housing search and support with the relocation process", "Requirements and documents needed for a work visa application"],
			planList2Extra: ["Updates", "Upcoming events and opportunities to settle and work in Luxembourg", "Advice on how to apply and where to settle in", "⁠Housing search and support with the relocation process", "Requirements and documents needed for a work visa application", "2 days of personalized assistance"],
			planTitle3: "Entrepreneur",
			planContent3: "Start a business in Luxembourg",
			planList3: ["Updates", "Upcoming events and opportunities to settle in the Grand Duchy", "Advice, guide on tax and advantages of settling in Luxembourg", "Housing search and support with the relocation process"],
			planList3Extra: ["Updates", "Upcoming events and opportunities to settle in Luxembourg", "Advice on tax opportunities in Luxembourg", "⁠Housing search and support with the relocation process", "Requirements and documents needed for an entrepreneur/investor visa application", "2 days of personalized assistance"],
	...
	fr: {
		...
		services: {
			...
			planList1Extra:["Mises à jour.", "Événements et opportunités à venir pour les étudiants internationaux.", "Conseils sur la façon de postuler et où s'installer.", "Accompagnement continu tout au long de votre processus d'adaptation", "Traitement complet des documents et autorisations.","⁠Recherche de logement et accompagnement dans le processus de déménagement.","2 jours d'assistance personnalisée"],
			planTitle2:"Demandeur d'emploi",
			planContent2:"S'installer au Luxembourg.",
			planList2:["Mises à jour.",
				"Événement et opportunités à venir s'installer et travailler au Luxembourg.",
				"Conseils sur la façon de postuler et où s’installer.",
				"⁠Recherche de logement et accompagnement dans le processus de déménagement.",
				"Exigences et documents nécessaires à la demande de visa de travail.",
				],
			planList2Extra:["Mises à jour.",
				"Événement et opportunités à venir s'installer et travailler au Luxembourg.",
				"Conseils sur la façon de postuler et où s’installer.",
				"⁠Recherche de logement et accompagnement dans le processus de déménagement.",
				"Exigences et documents nécessaires à la demande de visa de travail.",
			...
			planList3:["Mises à jour.",
				"Événement et opportunités à venir s'installer au grand-duché.",
				"Conseils, guide sur la façon fiscal et avantages s’installer au Luxembourg.",
				"Recherche de logement et accompagnement dans le processus de déménagement."],
			planList3Extra:["Mises à jour.",
				"Événement et opportunités à venir s'installer au Luxembourg.",
				"Conseils sur la façon opportunité fiscal au Luxembourg.",
				"⁠Recherche de logement et accompagnement dans le processus de déménagement.",
				"Exigences et documents nécessaires à la demande de visa de entrepreneur/ investisseur.",
				"2 jours d'assistance personnalisée.",
				],
