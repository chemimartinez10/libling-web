export const dict = {
	...
	en: {
		...
		home: {
			...
			reviewName_1: "MARIA SMITH",
			reviewDescription_1:
				"'I have been living in Luxembourg for 6 months thanks to Libling. I was able to find a job in the technology sector, where I specialize the most. They also helped me with opening a bank account, residence permit application, and making friends in Luxembourg.'",
			reviewName_2: "LUIS MORENO",
			reviewDescription_2:
	...
	fr: {
		...
		home: {
			...
			reviewName_1: "MARIA SMITH",
			reviewDescription_1:
				"'Cela fait 6 mois que je vis au Luxembourg grâce à Libling. J'ai pu trouver un emploi dans le secteur de la technologie, là où je suis le plus spécialisé. Ils m'ont également aidé à ouvrir un compte bancaire, à faire la demande de permis de résidence et à me faire des amis au Luxembourg.'",
			reviewName_2: "LUIS MORENO",
			reviewDescription_2:
