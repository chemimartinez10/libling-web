    ...
    <main className={styles.main}>
      ...
      <Section subtitle={glosary.sectionTitle_2} resume={glosary.sectionContent_2}>
        <div className={styles.listContactCards}>
          ...
          <link href="https://www.facebook.com/profile.php?id=61554771181200"><ContactCard description='+897287298724' Icon={RiMessengerLine} color={'#225FE7'} /></link>
          <link href="https://www.instagram.com/libling_solutions/"><ContactCard description='+897287298724' Icon={RiInstagramLine} color={'#FB8501'} /></link>
          <link href="https://www.linkedin.com/company/libling/"><ContactCard description='+897287298724' Icon={RiLinkedinFill} color={'#F0C712'} /></link>
        </div>
      </Section>
