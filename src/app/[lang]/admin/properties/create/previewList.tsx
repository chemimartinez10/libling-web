...
interface IPreviewList extends IPage {
    files: any[]
}



const PreviewList: React.FC<IPreviewList> = ({ params: { lang }, files }) => {
        ...
        <div className={styles.cardBody}>
            <div className={styles.cardSection}>
                <div className={styles.sectionRow}>
                    ...
                    <span style={poppinsMedium.style} className={styles.sectionLink} onClick={() => { }}>{glosary.formLinkEdit}</span>
                </div>
